...
const AddTransactionModal = ({
  ...
  const expenseCategories = ["Food", "Housing", "Transport", "Shopping", "Entertainment", "Utilities", "Healthcare", "Other"];
                  ...
                  <button
                    ...
                    onClick={() =>
                      setNewTransaction((prev) => ({
                        ...prev,
                        type: 'income',
                        category: "Salary", // ✅ reset category
                      }))
                    }
                  >
                    Income
