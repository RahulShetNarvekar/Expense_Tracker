...
const Income = () => {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return timeFrameTransactions.filter((t) => {
      ...
      return t.category?.trim().toLowerCase() === filter?.trim().toLowerCase()
    });
  ...
  const fetchOverview = useCallback(
    async (range = timeFrame) => {
        ...
        const res = await axios.get(`${API_BASE}/income/overview`, {
            ...
            params: { range: range.toLowerCase() }, // FIX
        });
  ...
  const totalIncome =
    overview?.totalIncome !== undefined && overview?.totalIncome !== null
    ...
    const averageIncome =
    overview?.averageIncome !== undefined && overview?.averageIncome !== null
    ...
    overview?.numberOfTransactions !== undefined &&
    overview?.numberOfTransactions !== null
